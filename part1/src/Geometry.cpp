...
void Geometry::AddVertex(float x, float y, float z, float xn, float yn, float zn, float s, float t){
...
void Geometry::MakeTriangle(vector<unsigned int> &verts){
    unsigned int vert0 = verts[0];
    unsigned int vert1 = verts[1];
    unsigned int vert2 = verts[2];
